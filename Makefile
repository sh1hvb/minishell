...
SRC_SMARSI =  parsing/parsing.c parsing/linked_list/pars_lst.c parsing/linked_list/heredoc_lst.c parsing/syntax/pipe_syntax.c parsing/syntax/syntax.c parsing/syntax/quotes_syntax.c parsing/syntax/files_syntax.c\
	helpers/errors.c\
...
$(NAME) : $(OBJ_SMARSI) $(OBJ_MCHIHAB)
	make -C $(LIBFT_PATH)
	cc  $(CFLAGS) -lreadline -fsanitize=address $(OBJ_SMARSI) $(OBJ_MCHIHAB) $(NAME_LIBFT) -o $(NAME)
