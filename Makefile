...
SRC = main.c \
	parsing/syntax.c parsing/parsing.c  parsing/linked_list/pars_lst.c parsing/linked_list/ft_lstclear.c\
	...
	expand/expand.c libft_ftmalloc/free_libft.c libft_ftmalloc/ft_split.c
